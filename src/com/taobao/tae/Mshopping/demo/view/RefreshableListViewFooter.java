...
public class RefreshableListViewFooter extends LinearLayout {
	...
	private void initView(Context context) {
		mContext = context;
		LinearLayout moreView = (LinearLayout) LayoutInflater.from(mContext).inflate(R.layout.view_more, null);
		addView(moreView);
		moreView.setLayoutParams(new LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.WRAP_CONTENT));

		mContentView = moreView.findViewById(R.id.view_more_content);
		mProgressBar = moreView.findViewById(R.id.view_more_progressbar);
		mHintView = (TextView) moreView.findViewById(R.id.view_more_hint_textview);
	}
