 ...
 */
public abstract class PinterestAbsListView extends PinterestAdapterView<ListAdapter> implements ViewTreeObserver.OnGlobalLayoutListener,
     ...
     * Acts upon click
     */
    private PinterestAbsListView.PerformClick mPerformClick;
    ...
    public PinterestAbsListView(Context context) {
        super(context);
        initAbsListView();
    ...
    public PinterestAbsListView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.absListViewStyle);
    }

    public PinterestAbsListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public boolean showContextMenuForChild(View originalView) {
        ...
        if (longPressPosition >= 0) {
            ...
            if (mOnItemLongClickListener != null) {
                handled = mOnItemLongClickListener.onItemLongClick(PinterestAbsListView.this, originalView, longPressPosition, longPressId);
            }
            if (!handled) {
        ...
        case MotionEvent.ACTION_UP: {
            ...
            case TOUCH_MODE_DONE_WAITING:
                ...
                if (child != null && !child.hasFocusable()) {
                    ...
                    final PinterestAbsListView.PerformClick performClick = mPerformClick;
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new PinterestAbsListView.LayoutParams(getContext(), attrs);
    }

    @Override
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof PinterestAbsListView.LayoutParams;
    }
    ...
    class RecycleBin {
        ...
        void addScrapView(View scrap) {
            PinterestAbsListView.LayoutParams lp = (PinterestAbsListView.LayoutParams) scrap.getLayoutParams();
            if (lp == null) {
                return;
            }
        ...
        void scrapActiveViews() {
            ...
            for (int i = count - 1; i >= 0; i--) {
                ...
                if (victim != null) {
                    int whichScrap = ((PinterestAbsListView.LayoutParams) victim.getLayoutParams()).viewType;
