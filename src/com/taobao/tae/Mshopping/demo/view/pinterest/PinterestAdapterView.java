 ...
 */
public abstract class PinterestAdapterView<T extends Adapter> extends ViewGroup {
    ...
    public PinterestAdapterView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PinterestAdapterView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public interface OnItemClickListener {
         ...
         */
        void onItemClick(PinterestAdapterView<?> parent, View view, int position, long id);
    }
    ...
    public interface OnItemLongClickListener {
         ...
         */
        boolean onItemLongClick(PinterestAdapterView<?> parent, View view, int position, long id);
    }
    ...
    public interface OnItemSelectedListener {
         ...
         */
        void onItemSelected(PinterestAdapterView<?> parent, View view, int position, long id);
         ...
         */
        void onNothingSelected(PinterestAdapterView<?> parent);
    }
    ...
    class AdapterDataSetObserver extends DataSetObserver {
        ...
        public void onChanged() {
            ...
            if (PinterestAdapterView.this.getAdapter().hasStableIds() && mInstanceState != null && mOldItemCount == 0 && mItemCount > 0) {
                PinterestAdapterView.this.onRestoreInstanceState(mInstanceState);
                mInstanceState = null;
            } else {
                rememberSyncState();
            }
        ...
        public void onInvalidated() {
            ...
            if (PinterestAdapterView.this.getAdapter().hasStableIds()) {
                // Remember the current state for the case where our hosting
                // activity is being
                // stopped and later restarted
                mInstanceState = PinterestAdapterView.this.onSaveInstanceState();
            }
