...
package com.taobao.tae.Mshopping.demo.image;
...
public class DiskLruCache {
	 ...
	 * {@link DiskLruCache#openCache(android.content.Context, java.io.File, long)} which runs some extra
	 ...
	 * be called directly, call {@link DiskLruCache#clearCache(android.content.Context, String)}
	 ...
	 * {@link DiskLruCache#setCompressParams(android.graphics.Bitmap.CompressFormat, int)} first to set
