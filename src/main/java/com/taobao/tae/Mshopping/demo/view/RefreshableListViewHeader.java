...
public class RefreshableListViewHeader extends LinearLayout {
	...
	private void initView(Context context) {
		...
		mArrowImageView = (ImageView)findViewById(R.id.pull_to_refresh_arrow);
		mHintTextView = (TextView)findViewById(R.id.pull_to_refresh_hint_textview);
		mProgressBar = (ProgressBar)findViewById(R.id.pull_to_refresh_progressbar);
