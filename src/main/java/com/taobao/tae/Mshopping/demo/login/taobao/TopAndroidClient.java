...
public class TopAndroidClient {
    private static final java.util.concurrent.ConcurrentHashMap<java.lang.String, TopAndroidClient> CLIENT_STORE = new ConcurrentHashMap<String, TopAndroidClient>();
