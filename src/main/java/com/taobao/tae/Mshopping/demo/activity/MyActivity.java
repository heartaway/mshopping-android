...
import com.taobao.tae.Mshopping.demo.activity.imgupload.PicMainActivity;
...
public class MyActivity extends BaseActivity {
    ...
    public void setButtonListen() {
        ...
        RelativeLayout imageUploadLayout = (RelativeLayout) findViewById(R.id.image_upload_layout);
        imageUploadLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MyActivity.this, PicMainActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                intent.putExtra("ACTIVITY_NAME_KEY", R.string.title_activity_login);
                startActivity(intent);
            }
